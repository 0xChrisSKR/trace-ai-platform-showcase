...
AI workflow design, TypeScript, Next.js product surface, workspace UI planning, runtime architecture, review trail concepts, infrastructure design

## Architecture

Human operator -> Workspace UI -> Agent workflow -> Shared execution state -> Review trail -> Infrastructure boundary
